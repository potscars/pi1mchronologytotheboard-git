...
class DBStrings: NSObject {
    ...
    static let DB_FULL_APPNAME: String = "Dashboard Komuniti (IOS)"
    ...
    static let DB_BUTTON_YES_LABEL_EN: String = "Yes"
    static let DB_BUTTON_YES_LABEL_MS: String = "Ya"
    static let DB_BUTTON_NO_LABEL_EN: String = "No"
    static let DB_BUTTON_NO_LABEL_MS: String = "Tidak"
    ...
    static let DB_LOGIN_IC_LABEL_EN: String = "ID User"
    ...
    static let DB_LOGIN_DESC_LABEL_EN: String = "Your ID user will be used as login to the app."
    ...
    static let DB_MENU_MYGAMES: String = "MyGames"
    static let DB_MENU_MYPLACES = "MyPlaces"
    ...
    //MyQuiz
    static let DB_MODULE_MYQUIZ_TNCLABEL_BUTTON_EN: String = ""
    static let DB_MODULE_MYQUIZ_TNCLABEL_BUTTON_MS: String = "Terma dan Syarat"
    static let DB_MODULE_MYQUIZ_PHONEASK_TITLE_EN: String = ""
    static let DB_MODULE_MYQUIZ_PHONEASK_TITLE_MS: String = "Maklumat Diperlukan"
    static let DB_MODULE_MYQUIZ_PHONEASK_DESC_EN: String = ""
    static let DB_MODULE_MYQUIZ_PHONEASK_DESC_MS: String = "Sila baca terma dan syarat terlibat dalam aktiviti ini. Masukkan no. telefon yang digunakan dan terma & syarat yang diberikan."
    static let DB_MODULE_MYQUIZ_PHONEASK_PLACEHOLDER_EN: String = ""
    static let DB_MODULE_MYQUIZ_PHONEASK_PLACEHOLDER_MS: String = "Sila masukkan nombor telefon yang betul"
    static let DB_MODULE_MYQUIZ_PHONECONFIRM_TITLE_EN: String = ""
    static let DB_MODULE_MYQUIZ_PHONECONFIRM_TITLE_MS: String = "Kepastian"
    static let DB_MODULE_MYQUIZ_PHONECONFIRM_DESC_EN: String = ""
    static let DB_MODULE_MYQUIZ_PHONECONFIRM_DESC_MS: String = "Sila pastikan nombor telefon anda tepat:"
