//
//  MyShopTinggiPernilaianCVC.swift
//  dashboardv2
//
...
class MyShopTinggiPernilaianCVC: UICollectionViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        navigationItem.title = "Produk Tinggi Pernilaian"
    }
    
    private func populateData() {
        
        let urlString = DBSettings.myShopHiRatingProductURL
...
extension MyShopTinggiPernilaianCVC {
...
extension MyShopTinggiPernilaianCVC: UICollectionViewDelegateFlowLayout {
